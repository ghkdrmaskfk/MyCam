...
data class CampingBasedItemsEntity(val items: CampingBasedItemEntity)

data class CampingBasedItemEntity(val item: List<CampingBasedInfoEntity>)

data class CampingBasedInfoEntity(val contentId: String?,
                                  val facltNm: String?,
