package com.hoon.data.lookup.mapper

import com.hoon.data.lookup.model.CampingBasedInfoEntity
import com.hoon.data.utils.default
import com.hoon.domain.lookup.model.CampingBasedInfoVo

fun List<CampingBasedInfoEntity>.mapperToCampingBasedInfoVo(): List<CampingBasedInfoVo> {
    val list = arrayListOf<CampingBasedInfoVo>()
    forEach {
        list.add(CampingBasedInfoVo(
